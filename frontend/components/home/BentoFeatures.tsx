    ...
    <section className="section" style={{ background: '#0A0C12', padding: '100px 0' }}>
      <div className="container">
        ...
        >
          ...
          <h2 className="section__title" style={{ fontSize: '48px', marginBottom: '20px', fontWeight: 800, color: '#0F172A' }}>
            Everything you need to <span style={{ color: '#0284C7' }}>succeed</span>.
          </h2>
          <p className="section__subtitle" style={{ maxWidth: '600px', margin: '0 auto', fontSize: '18px', color: '#475569' }}>
        ...
        >
          ...
          <motion.div variants={itemVariants} whileHover={{ y: -8, scale: 1.02 }} style={{ gridColumn: 'span 2', background: '#FFFFFF', borderRadius: '24px', padding: '48px', position: 'relative', overflow: 'hidden', border: '1px solid #E2E8F0', boxShadow: '0 20px 40px rgba(15,23,42,0.05)', cursor: 'default' }}>
          ...
          {/* Small Feature 1 */}
          <motion.div variants={itemVariants} whileHover={{ y: -8, scale: 1.05 }} style={{ background: '#FFFFFF', borderRadius: '24px', padding: '40px', border: '1px solid #E2E8F0', boxShadow: '0 20px 40px rgba(15,23,42,0.05)' }}>
          ...
          <motion.div variants={itemVariants} whileHover={{ y: -8, scale: 1.02 }} style={{ gridColumn: 'span 2', background: '#F8FAFC', borderRadius: '24px', padding: '48px', border: '1px solid #E2E8F0', boxShadow: '0 20px 40px rgba(15,23,42,0.05)' }}>
